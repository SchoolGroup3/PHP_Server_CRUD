...
document.addEventListener('DOMContentLoaded', function (e) {
    ...
    if (actualProfile.email) {
        ...
        document.getElementById("phone").value = actualProfile.telephone.replace(/\s/g, '');
    ...
    document.getElementById('profileForm').addEventListener('submit', async function (e) {
        ...
        const telephone = document.getElementById("phone").value.replace(/\s/g, ''); //remove spaces
        ...
        function hasChanges() {
            ...
            if (name !== actualProfile.name || surname !== actualProfile.surname || email !== actualProfile.email || username !== actualProfile.username || telephone !== actualProfile.telephone.replace(/\s/g, '') || gender !== actualProfile.gender || card_no !== actualProfile.card_no) {
                changes = true;
            }
            return changes;
        }
